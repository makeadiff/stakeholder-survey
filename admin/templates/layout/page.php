            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="questions.php"><i class="fa fa-dashboard fa-fw"></i> Questions</a></li>
                        <li><a href="answers.php"><i class="fa fa-dashboard fa-fw"></i> Answers</a></li>
                        <li><a href="aggregates.php"><i class="fa fa-dashboard fa-fw"></i> Aggregates</a></li>
                    </ul>
                    <!-- /#side-menu -->
                </div>
                <!-- /.sidebar-collapse -->
